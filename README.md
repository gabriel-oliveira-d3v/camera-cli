...
![Demonstração ASCII Colorida](https://via.placeholder.com/800x400?text=Execute+o+programa+para+ver+a+arte+ASCII+colorida+no+terminal)

*Execute o programa em um terminal compatível com True Color e aponte sua webcam para algo colorido. A mágica acontece!*

Exemplo (saída fictícia # 🎨 Webcam to Color ASCII Art
...
· Desenvolvido com ❤️ e Python.sem cores):
